...
public class Robot extends TimedRobot {
    /** Hardware */
	TalonSRX _talon = new TalonSRX(30);
	...
	void testLoop() {
		...
		_talon.set(ControlMode.PercentOutput, _joy.getRawAxis(1));
	...
	void commonLoop() {
		...
		SmartDashboard.putNumber("Position", _talon.getSelectedSensorPosition(0)/4096f);
		...
		if (button1) {
			...
			SmartDashboard.putNumber("setpoint", targetPositionRotations / 4096f);
			SmartDashboard.putNumber("error", targetPositionRotations - _talon.getSelectedSensorPosition());
		}
    }
